...
import { getMark, calcAverage } from "../api/MarksApiService";
import AverageListComponent from "./AverageListComponent";
import "../css/header.css"


function CalcAverageComponent() {
  ...
  async function onSubmit(values) {
    ...
    const messageRes = await calcAverage(mark);
    ...
    <Container>
      ...
      {isClicked && (
        <div>
          ...
          <AverageListComponent markListData={markListData} />
        </div>
      )}
    </Container>
  );
...
export default CalcAverageComponent;
