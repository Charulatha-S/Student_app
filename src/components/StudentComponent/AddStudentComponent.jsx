...
import { addStudentDetail } from "../api/StudentApiService";
...
function AddStudentComponent() {
  ...
  function validate(values) {
    ...
    if (
      values.studentName.length === 0 ||
      values.studentName.length < 5 ||
      values.studentName.length > 20
    ) {
        ...
        {() => (
          <div className="addForm">
            <Form>
              ...
              <br />
              <ErrorMessage name="contact" component="div" className="errorC" />
              <fieldset>
              ...
              <br />
              <ErrorMessage name="address" component="div" className="errorC" />
              <fieldset>
